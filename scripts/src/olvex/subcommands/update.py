...
from olvex.utils.dots.diff import Changeset
...
from olvex.utils.io import disable_input, fatal, info, log, prompt_selection, warn
...
class Command:
    ...
    def run(self) -> None:
        ...
        if state.applied_rev is None:
            fatal("dots not installed yet. Run `olvex install` first.")
