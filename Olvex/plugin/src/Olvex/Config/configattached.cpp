...
CONFIG_ATTACHED_GETTER(SettingsConfig, settings)
CONFIG_ATTACHED_GETTER(LauncherConfig, launcher)
CONFIG_ATTACHED_GETTER(NotifsConfig, notifs)
CONFIG_ATTACHED_GETTER(FlyoutsConfig, flyouts)
CONFIG_ATTACHED_GETTER(PowermenuConfig, powermenu)
CONFIG_ATTACHED_GETTER(WInfoConfig, winfo)
CONFIG_ATTACHED_GETTER(LockConfig, lock)
CONFIG_ATTACHED_GETTER(QspanelConfig, qspanel)
CONFIG_ATTACHED_GETTER(NotificationcenterConfig, notificationcenter)
