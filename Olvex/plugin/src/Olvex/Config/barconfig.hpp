...
class BarNetSpeed : public ConfigObject {
    Q_OBJECT
    QML_ANONYMOUS
    ...
    CONFIG_PROPERTY(int, fontSize, 11)
    CONFIG_PROPERTY(int, maxDigits, 0)

public:
    explicit BarNetSpeed(QObject* parent = nullptr)
        : ConfigObject(parent) {}
};

class BarBottomPanel : public ConfigObject {
    Q_OBJECT
    QML_ANONYMOUS
