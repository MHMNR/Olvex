...
class AppearanceConfig : public ConfigObject {
    ...
    CONFIG_GLOBAL_PROPERTY(QString, themeMode, QStringLiteral("dark"))
    CONFIG_GLOBAL_PROPERTY(QString, schemeVariant, QStringLiteral("tonalspot"))
    CONFIG_GLOBAL_PROPERTY(QString, primaryColor, QStringLiteral("#3584e4"))
