...
class UtilitiesToasts : public ConfigObject {
    ...
    CONFIG_GLOBAL_PROPERTY(bool, headphones, true)
    CONFIG_GLOBAL_PROPERTY(bool, usbDevices, true)
    CONFIG_GLOBAL_PROPERTY(bool, bluetoothDevices, true)
...
class QspanelConfig : public ConfigObject {
    Q_OBJECT
    QML_ANONYMOUS
...
public:
    explicit QspanelConfig(QObject* parent = nullptr)
        : ConfigObject(parent)
