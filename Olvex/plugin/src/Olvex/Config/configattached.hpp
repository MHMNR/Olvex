...
class Config : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const olvex::config::ControlCenterConfig* controlCenter READ controlCenter NOTIFY sourceChanged)
    ...
    Q_PROPERTY(const olvex::config::OsdConfig* osd READ osd NOTIFY sourceChanged)
    Q_PROPERTY(const olvex::config::SessionConfig* session READ session NOTIFY sourceChanged)
    ...
    Q_PROPERTY(const olvex::config::UtilitiesConfig* utilities READ utilities NOTIFY sourceChanged)
    Q_PROPERTY(const olvex::config::SidebarConfig* sidebar READ sidebar NOTIFY sourceChanged)
