...
from olvex.utils.dots.packages import PackageInstaller
from olvex.utils.dots.source import DotsSource
from olvex.utils.io import info, log, warn
from olvex.utils.paths import dots_dir
...
def run_hooks(manifest: Manifest, kind: str) -> None:
    ...
    env = {**os.environ, "OLVEX_DOTS": str(dots_dir), "CAELESTIA_DOTS": str(dots_dir)}
    for hook in hooks:
