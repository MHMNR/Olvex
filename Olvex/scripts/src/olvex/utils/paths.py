...
c_config_dir: Path = config_dir / "olvex"
c_data_dir: Path = data_dir / "olvex"
c_state_dir: Path = state_dir / "olvex"
c_cache_dir: Path = cache_dir / "olvex"
...
wallpapers_dir: Path = Path(os.getenv("OLVEX_WALLPAPERS_DIR", os.getenv("CAELESTIA_WALLPAPERS_DIR", pictures_dir / "Wallpapers")))
...
screenshots_dir: Path = Path(os.getenv("OLVEX_SCREENSHOTS_DIR", os.getenv("CAELESTIA_SCREENSHOTS_DIR", pictures_dir / "Screenshots")))
screenshots_cache_dir: Path = c_cache_dir / "screenshots"

recordings_dir: Path = Path(os.getenv("OLVEX_RECORDINGS_DIR", os.getenv("CAELESTIA_RECORDINGS_DIR", videos_dir / "Recordings")))
