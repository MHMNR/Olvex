...
ColumnLayout {
    ...
    // Header elements moved to ExpansionOverlay.qml
    ...
    ScrollView {
        ...
        Layout.preferredHeight: Math.min(contentItem.childrenRect.height, 180)
        ...
        Component.onCompleted: {
            if (contentItem) {
                ...
                contentItem.boundsMovement = Flickable.FollowBoundsBehavior;
            }
        }
        ...
        ColumnLayout {
            ...
            Repeater {
                model: ScriptModel {
                    values: [...Bluetooth.devices.values].sort((a, b) => (b.connected - a.connected) || (b.paired - a.paired) || a.name.localeCompare(b.name)).slice(0, 20) // qmllint disable unresolved-type
                }
