...
DeviceDetails {
    ...
    readonly property bool providerEnabled: {
        if (!vpnProvider || vpnProvider.index === undefined)
            return false;
        const provider = GlobalConfig.qspanel.vpn.provider[vpnProvider.index];
                ...
                SectionContainer {
                    ...
                    RowLayout {
                        ...
                        TextButton {
                            ...
                            onClicked: {
                                const provider = GlobalConfig.qspanel.vpn.provider[root.vpnProvider.index];
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                ...
                TextButton {
                    ...
                    onClicked: {
                        const providers = [];
                        const oldProvider = GlobalConfig.qspanel.vpn.provider[editVpnDialog.editIndex];
