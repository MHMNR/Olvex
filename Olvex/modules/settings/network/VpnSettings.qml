...
ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            StyledText {
                                ...
                                font.weight: modelData.isActive ? 400 : 400
                            }
                        ...
                        IconButton {
                            ...
                            visible: !modelData.isActive || GlobalConfig.qspanel.vpn.provider.length > 1
                            onClicked: {
                                const providers = [];
    ...
    SectionContainer {
        ...
        TextButton {
            ...
            onClicked: {
                const providers = [...GlobalConfig.qspanel.vpn.provider];
                providers.push({
                    name: "netbird",
                    displayName: "NetBird",
                    interface: "wt0"
