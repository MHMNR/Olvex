...
Item {
    ...
    readonly property var sections: [
        ...
        { id: "status", label: qsTr("Status Icons"), icon: "info" },
        { id: "workspaces", label: qsTr("Workspaces"), icon: "space_dashboard" },
        { id: "widgets", label: qsTr("Widgets & Tray"), icon: "widgets" },
        { id: "bottomPanel", label: qsTr("Bottom Panel"), icon: "view_compact_alt" }
    ]
