...
Item {
    ...
    property int maxToasts: Config.qspanel.maxToasts ?? 4
    property string toastsFullscreen: Config.qspanel.toasts.fullscreen ?? "off"
    property bool chargingChanged: GlobalConfig.qspanel.toasts.chargingChanged ?? true
    property bool gameModeChanged: GlobalConfig.qspanel.toasts.gameModeChanged ?? true
    property bool dndChanged: GlobalConfig.qspanel.toasts.dndChanged ?? true
    property bool audioOutputChanged: GlobalConfig.qspanel.toasts.audioOutputChanged ?? true
    property bool audioInputChanged: GlobalConfig.qspanel.toasts.audioInputChanged ?? true
    property bool capsLockChanged: GlobalConfig.qspanel.toasts.capsLockChanged ?? true
    property bool numLockChanged: GlobalConfig.qspanel.toasts.numLockChanged ?? true
    property bool kbLayoutChanged: GlobalConfig.qspanel.toasts.kbLayoutChanged ?? true
    property bool vpnChanged: GlobalConfig.qspanel.toasts.vpnChanged ?? true
    property bool nowPlaying: GlobalConfig.qspanel.toasts.nowPlaying ?? false
    ...
    function saveConfig(): void {
        ...
        GlobalConfig.qspanel.maxToasts = root.maxToasts;
        GlobalConfig.qspanel.toasts.fullscreen = root.toastsFullscreen;
        GlobalConfig.qspanel.toasts.chargingChanged = root.chargingChanged;
        GlobalConfig.qspanel.toasts.gameModeChanged = root.gameModeChanged;
        GlobalConfig.qspanel.toasts.dndChanged = root.dndChanged;
        GlobalConfig.qspanel.toasts.audioOutputChanged = root.audioOutputChanged;
        GlobalConfig.qspanel.toasts.audioInputChanged = root.audioInputChanged;
        GlobalConfig.qspanel.toasts.capsLockChanged = root.capsLockChanged;
        GlobalConfig.qspanel.toasts.numLockChanged = root.numLockChanged;
        GlobalConfig.qspanel.toasts.kbLayoutChanged = root.kbLayoutChanged;
        GlobalConfig.qspanel.toasts.vpnChanged = root.vpnChanged;
        GlobalConfig.qspanel.toasts.nowPlaying = root.nowPlaying;
    }
