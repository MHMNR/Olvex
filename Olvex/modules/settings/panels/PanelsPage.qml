    ...
    SettingsPage {
        ...
        Section {
            ...
            SettingRow {
                ...
                StyledSwitch {
                    checked: Config.notificationcenter.enabled
                    onToggled: {
        ...
        Section {
            ...
            SettingRow {
                ...
                StyledSwitch {
                    checked: Config.flyouts.enabled
                    onToggled: {
            ...
            SettingRow {
                ...
                StyledSwitch {
                    checked: Config.flyouts.enableBrightness
                    onToggled: {
            ...
            SettingRow {
                ...
                StyledSwitch {
                    checked: Config.flyouts.enableMicrophone
                    onToggled: {
        ...
        Section {
            ...
            SettingRow {
                ...
                StyledSwitch {
                    checked: Config.powermenu.enabled
                    onToggled: {
            ...
            SettingRow {
                ...
                divider: false
                StyledSwitch {
                    checked: Config.powermenu.vimKeybinds
                    onToggled: {
