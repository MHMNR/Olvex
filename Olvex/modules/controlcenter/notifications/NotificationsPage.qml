    ...
    SettingsPage {
        ...
        Section {
            ...
            SettingRow {
                ...
                CustomSpinBox {
                    value: Config.utilities.maxToasts ?? 4
                    min: 1
                    max: 8
                    step: 1
                    onValueModified: v => {
                        GlobalConfig.utilities.maxToasts = v;
                        GlobalConfig.save();
                    }
                }
            }
            SettingRow {
                ...
                Segmented {
                    ...
                    currentIndex: {
                        const v = Config.utilities.toasts.fullscreen || "off";
                        return v === "off" ? 0 : v === "important" ? 1 : 2;
                    }
                    onSelected: i => {
                        GlobalConfig.utilities.toasts.fullscreen = ["off", "important", "on"][i];
                        GlobalConfig.save();
                    }
                }
            }
