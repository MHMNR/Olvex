...
Item {
    ...
    StyledClippingRect {
        ...
        ScreencopyView {
            ...
            readonly property bool canPreview: Hypr.canLivePreviewToplevel(root.client)

            captureSource: canPreview ? (root.client?.wayland ?? null) : null // qmllint disable unresolved-type
            live: canPreview
